  ...
  return (
    <section className="col-[full]">
      <div className="grid grid-cols-3">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="col-start-1 row-start-1 col-end-4 row-end-4 h-[800px] md:max-h-[600px] relative">
