const CommentCard = async ({ params }) => {
  ...
  const response = await fetch(`http://localhost:4000/comments?blogpostId=${id}`, { cache: "no-store" });
  ...
  return (
    <>
      <section className="col-[content] mb-2 mt-12">
        <h2 className="uppercase">{commentCount} Comments</h2>
